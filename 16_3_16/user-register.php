...
<!--    <form class="form-horizontal" role="form">-->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" id="forename" name="username" type="text" placeholder="Enter Name...">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" id="confirm_pwd" name="confirm_pwd" type="password" placeholder="Confirm your password...">
      </div>
    </div>
    <div class="form-group">
