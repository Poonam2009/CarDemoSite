...
//    function check_all_make()
//    {
//      alert("in the check all make");  
...
//    }
    ...
    function select_all_makes_models_active(source){
        
       // alert("in the all makes and models");
        checkboxes = document.getElementsByName('make[]');
		for(var i in checkboxes)
			checkboxes[i].checked = source.checked;
                    
                     checkboxes2 = document.getElementsByName('model[]');
		for(var j in checkboxes)
			checkboxes2[j].checked = source.checked;
        
    }
    
    function check_all_make(source) {
		checkboxes = document.getElementsByName('make[]');
		for(var i in checkboxes)
			checkboxes[i].checked = source.checked;
	}
...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	    <div class="navbar-header">
	        ...
	        <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="../../images/logo.png" alt="" class="img-responsive"></a>
	    </div>
	    <!--/.navbar-header-->
...
<!-- banner -->
    ...
    <div  class="myaccout"> <h1 style="float:left">Register Workshop</h1>
    <ol class="breadcrumb myac">
    <li><a href="<?php echo base_url(); ?>">Home</a></li>
    <li class="active">Register Workshop</li>        
  	</ol>
  	</div>
	<!-- //banner -->
                ...
                <div class="col-lg-6">
                    <div class="col-sm-12 divcheck">
                          ...
                          <h2>Makes Serviced</h2>
                             <div class="form-group">
                                  <div class="col-sm-2">
                                    <input id="select_all_makes_models" name="select_all_makes_models" type="checkbox" onClick="select_all_makes_models_active(this)">
                                  </div>
                                  <label class="col-sm-10" style="color:#000; font-size:18px">All Makes and Models</label>
                              </div>
                             <div class="form-group">
                                  <div class="col-sm-2">
<!--                                    <input id="selected_makes" name="selected_makes" type="checkbox">-->
                                    <input id="select_allmakes" name="select_allmakes" type="checkbox" onclick="check_all_make(this)">
                                  </div>
                                  <label class="col-sm-10" style="color:#000; font-size:18px">Select All Makes</label>
                            </div>
                            <h2>Select Makes </h2> 
                            <div class="col-sm-12">
                            <?php
                            ...
                            foreach ($query->result() as $row){?>
                                <div class="col-md-4"><input type='checkbox' name='model[]' value='<?php echo $row->model_id; ?>' /><?php echo $row->model_name; ?></div>
                            <?php }
                            ?>
                            </div>
...
<!--                            <div class="col-sm-4">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-sm-3">
        <div class="form-group"><input type="time" name="mon_start" onkeydown="event.preventDefault();"></div>
        </div>
        <div class="col-sm-3">
        <label>To</label>
        </div>
