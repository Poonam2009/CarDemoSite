	...
	public function index()
	{
           ...
           public function addUser()
        {
	       $username=$_POST['username'];
               ...
               $this->form_validation->set_rules('email', 'Email','trim|required|max_length[12]|valid_email|callback_isEmailExist');
               $this->form_validation->set_rules('password', 'password','trim|required|matches[conf_password]|callback_max_length[4]');
      ...
      {
    	if (strlen($this->input->post('password')) > $val)
    	{
