...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
    <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><i class="glyphicon glyphicon-list"></i>Mapping List</a></li>
     <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a href="#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2"><i class="glyphicon glyphicon-list"></i>Make-Model-Mapp</a></li>
   <div class="col-sm-3 col-md-3 pull-right">
        <div class="input-group">
        <input id="filter" type="text" class="form-control" placeholder="Search here..." style="margin-top: 5px; margin-bottom: 5px;
">
        </div>
  </div> 
  </ul>
...
//    }
        ...
        $query = $this->db->query('SELECT * FROM make_model_mapp');
                ...
                <tr>
                     ...
                     <td>
                        ...
                        <td>
                                ...
                                $this->db->select('*');
                                $this->db->from('make');
                                //$this->db->join('make_name');
                                $this->db->where('make_id',$row->make_id); 
                                $query2 = $this->db->get();
...
$this->db->from('model');
//$this->db->join('make_name');
$this->db->where('model_id',$row->model_id); 
$query3 = $this->db->get();
...
<!--                         <td style="text-align:center;">
                         ...
                         data-target="#myModal" onClick="editModel(<?php echo $row->model_id;?>,'<?php echo $row->make_id;?>')">Edit</button></td>
	...
	echo validation_errors();
		...
		echo form_open('MnfMappModelController/makeMappModel', $form_att);
	...
	?>
        <!-- <form role="form" action="book-action.php"  method="post" enctype="multipart/form-data">-->
                 ...
                 <div class="row">
                  <div class="col-lg-6">
                        <div class="form-group">
                            <label>Select Manufacturer Name*</label><br />
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                    <label>Select Model Name*</label><br />
                ...
                <button type="submit" id="addMnfMappModel" name="addMnfMappModel" class="btn btn-default" onclick="validateFrmeCategory();">Save</button>
