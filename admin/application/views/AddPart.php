...
<style>
 ...
 <section id="main-content">
  ...
  <script>
      ...
      function editAddPart(part_id,part_name)
{
	
	var part_name=part_name;
	var part_ids=part_id;
	
	part_name=document.getElementById('eaddpart').value=part_name;
	part_ids=document.getElementById('partname_id').value=part_id;
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	echo validation_errors();
		...
		echo form_open('AddPartController/editpartname', $form_att);

	?>
                                         
            <div class="form-group">
              <label>Add Part Name*</label><br />
              <input type="text" class="form-control" style="width: 85%;" name="eaddpart" id="eaddpart" value=""   required/>
             </div> 
            <button type="submit" id="editpartname" name="editpartname" class="btn btn-default">Update Part Name</button>
        <input type="hidden" name="partname_id" id="partname_id" value="">
<!--        </form>-->
        <?php echo form_close(); ?>
      </div>
...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
    <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><i class="glyphicon glyphicon-list"></i>Part List</a></li>
     <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a href="#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2"><i class="glyphicon glyphicon-list"></i>Add Part</a></li>
   </ul>
...
//}
               ...
               <td>
                ...
                <td>
                         ...
                         data-target="#myModal" onClick="editAddPart(<?php echo $row->part_id;?>,'<?php echo $row->part_name;?>')">Edit</button></td>
	...
	echo validation_errors();
		...
		echo form_open('AddPartController/AddPart', $form_att);
	...
	?>
        <!-- <form role="form" action="book-action.php"  method="post" enctype="multipart/form-data">-->
                 ...
                 <div class="col-lg-12">
                  <div class="col-lg-6"> 
                <div class="form-group">
                  <label>Enter Part Name*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="addpart" id="addpart" placeholder="Enter Past Name" value="" maxlength="100" required/>
                </div> 
                <div id="service_typeErr" class="eor"></div> 
               </div>
                <div class="col-lg-6"> 
                <br>
                 
                <button type="submit" id="aadpart_name" name="aadpart_name" class="btn btn-default" onclick="validateFrmeCategory();">Add Part</button>
