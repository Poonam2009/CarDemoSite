...
<link href="<?php echo base_url('css/bootstrap.min.css'); ?>" rel="stylesheet" type="text/css"/>
 ...
 <link href="<?php echo base_url('css/xcharts.min.css'); ?>" rel="stylesheet" type="text/css"/>
  ...
  <section id="container" class="" style="padding: 9px 8px;">
          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?php echo base_url(); ?>index.php/HomeController">Home</a></li>
           ...
           <div class="row">
		    <div class="col-lg-9 col-md-12 portlets">
