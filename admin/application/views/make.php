...
<style>
 ...
 <section id="main-content">
  ...
  <script>
      ...
      function editMake(make_id,make_name)
{
	
	var make_name=make_name;
	var make_ids=make_id;
	
	make_name=document.getElementById('emake_name').value=make_name;
	make_ids=document.getElementById('make_name_id').value=make_id;
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	echo validation_errors();
		...
		echo form_open('MakeController/editMake', $form_att);

	?>
                                         
            <div class="form-group">
              <label>Manufacturer Name*</label><br />
              <input type="text" class="form-control" style="width: 85%;" name="emake_name" id="emake_name" value=""   required/>
             </div> 
            <div id="emake_nameErr" class="eor"></div> 
          
            <button type="submit" id="editMakeName" name="editMakeName" class="btn btn-default">Update Manufacturer Name</button>
        <input type="hidden" name="make_name_id" id="make_name_id" value="">
<!--        </form>-->
        <?php echo form_close(); ?>
      </div>
...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
    <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><i class="glyphicon glyphicon-list"></i>Make List</a></li>
     <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a href="#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2"><i class="glyphicon glyphicon-list"></i>Add Make</a></li>
   </ul>
...
<!--                             <a href="#" id="home_<?php echo $row->make_id ?>" class="edit btn default btn-xs purple"> 
                         ...
                         data-target="#myModal" onClick="editMake(<?php echo $row->make_id;?>,'<?php echo $row->make_name;?>')">Edit</button></td>
	...
	echo validation_errors();
		...
		echo form_open('MakeController/addMake', $form_att);
	...
	?>
        <!-- <form role="form" action="book-action.php"  method="post" enctype="multipart/form-data">-->
                ...
                <div class="form-group">
                  <label>Manufacturer Name*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="make_name" id="make_name" placeholder="Enter Make Name" value="" maxlength="100" required/>
                </div> 
                <div id="make_nameErr" class="eor"></div> 
               </div>
                <div class="col-lg-6"> 
                <br>
                 
                <button type="submit" id="addMake_name" name="addMake_name" class="btn btn-default" onclick="validateFrmeCategory();">Add Make</button>
