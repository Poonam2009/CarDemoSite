...
<!--<script type="text/javascript" src="/asset/ckeditor_4.5.7_basic/ckfinder/ckfinder.js"></script>-->
...
<style>
 ...
 <section id="main-content">
  ...
  <script>
      ...
      function editServiceName(sname_id,stype_id,stype_name,service_name,labour_cost)
     {
...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
	...
	<?php
        ...
        $sr=0;
        $query = $this->db->query('SELECT * FROM add_service');
                    ...
                    <td>
                        ...
                        <td>
                                <?php //echo $row->service_name; 
                                         ...
                                         $this->db->select('*');
                                $this->db->from('make');
                                $this->db->where('make_id',$row->make); 
                                $query2 = $this->db->get();
                        ...
                        <td>
                               ...
                               // echo $row->service_name; 
                                     $this->db->select('*');
                                $this->db->from('model');
                                $this->db->where('model_id',$row->model); 
                                $query3 = $this->db->get();
                        ...
                        <td>
                                ...
                                $this->db->where('varient_id',$row->varient); 
                                $query4 = $this->db->get();
                                foreach ($query4->result() as $row2){ 
                                echo $row2->varient_name; 
               ...
               <td>
                        ...
                        <td>
                               <button type="button" class="btn btn-info btn-small" onclick="location.href='<?php echo base_url();?>index.php/ServiceAdd/edit/<?php echo $row->aservice_id;?>'" >View</button></td>
			 ...
			 <select id="varient" name="varient" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <label>Service Description*</label><br />
                   <?php echo $this->ckeditor->editor("service_desc","default textarea value");?>   
<!--                  <input type="text" class="form-control" style="width: 75%;" name="service_name" id="service_name" placeholder="Enter Service Name" value="" maxlength="100" required/>-->
                </div>    
