...
<!--                        <td>
                        ...
                        <td>
                         ...
                         data-target="#myModal" onClick="editServiceName(<?php echo $row->sname_id;?>,<?php echo $row->stype_id;?>,'<?php echo $row2->stype_name;?>','<?php echo $row->service_name;?>','<?php echo $row->labour_cost;?>')">Edit</button></td>
