...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
    <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><i class="glyphicon glyphicon-list"></i>Make Model Mapp List</a></li>
     <li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false"><a href="#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2"><i class="glyphicon glyphicon-list"></i>Mapp Make Model</a></li>
   </ul>
...
//}
                ...
                <tr>
                       ...
                       <td>
                                ...
                                echo $row->make_model_mapp_id;
                              //  $this->db->where('make_id',$row->make_id);
//$this->db->select('make',$data); 
...
//          $result = $query->result();
 ...
 ?>
                        ...
                        <td><?php
                                $q = $this->db->query('SELECT * FROM make where make_id='.$row->make_id.'');
 ...
 ?>
               ...
               <td>
                           <?php
                                $q = $this->db->query('SELECT * FROM model where model_id='.$row->model_id.'');
 foreach ($q->result() as $t){
 echo $t->model_name; 
