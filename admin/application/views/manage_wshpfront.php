 ...
 <section id="main-content">
  ...
  <script>
	...
	return false;
        ...
        function view details(wshop_id)
        {
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Workshop status</h4>
      </div>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Veiw Workshop Details </h4>
      </div>
      <div class="modal-body" style="left-margin:30px">
        <div class="table-responsive">
        ...
        $query = $this->db->query('SELECT * FROM wshop_register');
               ...
               <td>
                        ...
                        <td>
                         ...
                         data-target="#myModal" onClick="editStatus(<?php echo $row->wshop_id;?>,<?php echo $row->status;?>)">change status</button></td>
                        
                        </td>

                        <td>
                               <button type="button" class="btn btn-info btn-small" onclick="location.href='<?php echo base_url();?>index.php/FrontWorkshopController/details/<?php echo $row->wshop_id;?>'" >View</button></td>
