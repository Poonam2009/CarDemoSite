...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	echo validation_errors();
		...
		echo form_open('AddWorkshopController/editWorkshop', $form_att);

	?>
                                         
            <div class="form-group">
                  <label>Enter Workshop  Name*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="ewshop_name" id="ewshop_name" placeholder="Enter Workshop Name" value="" maxlength="100" required/>
                </div> 
                   <div class="form-group">
                  <label>Enter Location*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="ewshop_location" id="ewshop_location" placeholder="Enter workshop Location" value="" maxlength="100" required/>
                </div> 
                    <div class="form-group">
                  <label>Enter Workshop  Categories*</label><br />
                      <select name="ewshop_category" id="ewshop_category" class="form-control" style="width: 75%;"  required>
                  ...
                  <input type="text" class="form-control" style="width: 75%;" name="ephone_no" id="ephone_no" placeholder="Enter Phone No." value="" maxlength="10" required/>
                </div> 
                   <div class="form-group">
                  <label>Enter Email*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="emaile" id="emaile" placeholder="Enter Email" value="" maxlength="50" required/>
                </div>  
                     
                 <div class="form-group">
                  <label>Username*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="elogin_username" id="elogin_username" placeholder="Enter User Name" value="" maxlength="20" required/>
                </div>  
                <div class="form-group">
                  <label>Password*</label><br />
                  <input type="text" class="form-control" style="width: 75%;" name="elogin_password" id="elogin_password" placeholder="Enter Password " value="" maxlength="12" required/>
                </div>  
                <br>
        
            <button type="submit" id="editwshop_name" name="editwshop_name" class="btn btn-default">Update </button>
        <input type="hidden" name="wshop_name_id" id="wshop_name_id" value="">
<!--        </form>-->
        <?php echo form_close(); ?>
      </div>
...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
  <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
    <li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-1" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><i class="glyphicon glyphicon-list"></i>Workshop List</a></li>
...
<!--                    <th>Created On</th>-->
	...
	<?php
        ...
        $sr=0;
        $query = $this->db->query('SELECT * FROM workshop_details');
                    ...
                    <td>
                        ...
                        <td>
                                <?php 
                                  ...
                                  //echo $row->wshop_name 
                                     echo wordwrap($row->wshop_name,10,"<br>\n");     
                                        ?>
                        </td>
               ...
               <td>
                                <?php //echo wordrap()echo $row->wshop_location 
                                        ...
                                        echo wordwrap($row->wshop_location,5,"<br>\n");
                                        ?>
                        </td>
                        
                        <td>
                                <?php echo $row->wshop_category ?>
                        </td>
                        <td>
