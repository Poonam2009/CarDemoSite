...
$this->db->update('model',$data); 
      ...
      redirect('ModelController/modelList','location',301); 
          ...
          public function add_varient($varient){
...
//echo $mac;
     ...
     // $uArr = explode('@',$this->input->post('emailaddress'));
      ...
      redirect('ModelController/varientList','location',301); 
	 }
         
         
          public function edit_varient($varient_id){
...
//echo $mac;
             ...
             // $uArr = explode('@',$this->input->post('emailaddress'));
              $data=array(
                'varient_name' => $_POST['evarient_name'],
               'modified_on' => $date,
               'modified_by' => $created_by,
                 'ip_address' => $this->input->ip_address(),
                'mac_address' => $macaddress
      ...
      redirect('ModelController/varientList','location',301); 
          ...
          public function show_all_varientlist(){
          $this->db->select('*');
