 ...
 class AddWorkshopModel extends CI_Model
{
   ...
   public function show_all_businesslist()
         {
...
public function add_Business($business_name)
        {
         ...
         redirect('AddWorkshopController/businesslist','location',301); 
        }      
        public function editbusiness_name($ebusiness_name_id)
         {
           ...
           $macaddress=substr($mycomsys,($pmac+36),17);  
             ...
             $created_by    = $this->session->userdata['username'];
              ...
              $data = array(
                     'business_name' => $this->input->post('ebusiness'),
                     'modified_on' => $date,
                     'modified_by' => $created_by,
                     'ip_address' => $this->input->ip_address(),
                     'mac_address' => $macaddress
        ...
        $this->db->where('business_id',$ebusiness_name_id);
        $this->db->update('business_type',$data); 

              redirect('AddWorkshopController/businesslist','location',301); 
                 }
                 
        public function show_all_facilitylist()
            {
...
public function add_Facility($facility_name)
        {
         ...
         redirect('AddWorkshopController/facilitylist','location',301); 
        }      
        public function editfacility_name($efacility_name_id)
         {
           ...
           $macaddress=substr($mycomsys,($pmac+36),17);  
             ...
             $created_by    = $this->session->userdata['username'];
              ...
              $data = array(
                     'facility_name' => $this->input->post('efacility'),
                     'modified_on' => $date,
                     'modified_by' => $created_by,
                     'ip_address' => $this->input->ip_address(),
                     'mac_address' => $macaddress
        ...
        $this->db->where('facility_id',$efacility_name_id);
        $this->db->update('facility_type',$data); 
              ...
              public function show_all_front_wshopRegList()
         {
