...
<!--    <script src="js/jquery.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="<?php echo base_url(); ?>index.php/HomeController" class="logo"><span class="lite">Admin</span></a>
            <!--logo end-->
...
<!--                            <li>
                            ...
                            <li>
                                <?php //echo base_url('css/structure.css'); ?>
<!--                                <a href="login.html"><i class="icon_key_alt"></i> Log Out</a>-->
                                 <a href="<?php echo base_url('index.php/LoginController/logout_user'); ?>"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
<!--                            <li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                      <a class="" href="<?php echo base_url(); ?>index.php/HomeController">
		 ...
		 <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/MakeController">Manage Manufacturers </a></li>                          
                          <li><a class="" href="<?php echo base_url(); ?>index.php/ModelController"> Manage Models</a></li>
                           <li><a class="" href="<?php echo base_url(); ?>index.php/ModelController/varientList"> Manage Varients</a></li>
                          <li><a class="" href="<?php echo base_url(); ?>index.php/MnfMappModelController">Make Model Mapping</a></li>
                      </ul>
                  </li> 
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/ServiceTypeController">Add Services Type</a></li> 
                          <li><a class="" href="<?php echo base_url(); ?>index.php/ServiceCatg">Services Category</a></li> 
                           <li><a class="" href="<?php echo base_url(); ?>index.php/ServiceAdd">Services Add</a></li> 
                          <li><a class="" href="<?php echo base_url(); ?>index.php/ServiceNameController">Add Services Name</a></li>
                     </ul>
                  </li>  
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          <i class="icon_document_alt"></i>
                          <span>Location/Intervals</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/LocIntController">Add Location</a></li>  
                           <li><a class="" href="<?php echo base_url(); ?>index.php/LocIntController/yearList">Add Year</a></li>  
                          <li><a class="" href="<?php echo base_url(); ?>index.php/LocIntController/intervalList">Add Intervals</a></li>
                     </ul>
                  </li>  
                   ...
                   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/ProductCategoriesControllers">Product Categories</a></li> 
                          <li><a class="" href="<?php echo base_url(); ?>index.php/AddProductController">Add Product </a></li> 
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/Customer">CustomerDetails</a></li> 
                   ...
                   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>index.php/AddWorkshopController">Add Workshop</a></li> 
                           <li><a class="" href="<?php echo base_url(); ?>index.php/AddWorkshopController/frontworkshopList"> Workshop List Front</a></li> 
                       
                          <li><a class="" href="<?php echo base_url(); ?>index.php/AddWorkshopController/businesstype">Add Business</a></li>
                          <li><a class="" href="<?php echo base_url(); ?>index.php/AddWorkshopController/FacilityType">Add Facilities</a></li>
                     </ul>
                  </li>
<!--                  <li class="sub-menu">
                      <a href="javascript:;" class="">
